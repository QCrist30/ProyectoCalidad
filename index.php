    ...
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                ...
                <div class="mbr-section-btn"><a class="btn btn-md btn-secondary display-4" href="index.php#services1-2">SERVICIOS</a>
    ...
    <div class="container">
        <div class="row justify-content-center">
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">
                            Masaje facial con cremas naturales y exfoliantes profesionales que le dan a su piel<br>un tono fresco y rejuvenece su semblante. Perfecto para actualizar su imagen</p>
                        <!--Btn-->
                        <div class="mbr-section-btn align-left"><a href="facial.php" class="btn btn-warning-outline display-4">
                                More...</a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="card col-12 col-md-6 p-3 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="assets/images/mbr-696x464.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-5">
                            Cortes</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Con las ultimas tendencias en nuestro catálogo ofrecemos diversos cortes y pulidos que se ajustan a tu personalidad y te dan un aire actual y limpio</p>
                        <!--Btn-->
                        <div class="mbr-section-btn align-left"><a href="cortes.php" class="btn btn-warning-outline display-4">
                                More...</a></div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-5">
                            Barba</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Expertos barberon haran de tu barba un aspecto distintivo de tu imagen. Con todos los productos, tecnicas y diseños especialmente para ti.</p>
                        <!--Btn-->
                        <div class="mbr-section-btn align-left"><a href="barba.php" class="btn btn-warning-outline display-4">
                                More...</a></div>
                    </div>
                </div>
            </div>
        ...
        <div class="media-container-row">
            ...
            <div class="col-md-9">
                <p class="mbr-text align-right links mbr-fonts-style display-7"><a href="index.php" class="text-black text-primary">INICIO</a> &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="nosotros.html#header1-g" class="text-black text-primary">NOSOTROS</a>&nbsp;&nbsp;&nbsp; &nbsp;<a href="contacto.html" class="text-black text-primary">CONTAC</a>TO</p>
            </div>
        </div>

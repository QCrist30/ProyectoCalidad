...
<section class="carousel slide cid-sbiixDMyXR" id="slider3-8">
    
    <div class="carousel slide" data-ride="carousel" id="scGtwVK16B">
        <ol class="carousel-indicators">
            <li data-slide-to="0" class="active" data-target="#scGtwVK16B"></li>
            <li data-slide-to="1" data-target="#scGtwVK16B"></li>
            <li data-slide-to="2" data-target="#scGtwVK16B"></li>
        </ol>
        <div class="carousel-inner">
            <div class="carousel-item slider-image item active">
                <div class="item-wrapper">
                    <img class="d-block w-100" src="assets/images/mbr-1920x1286.jpg">
            ...
            <div class="carousel-item slider-image item">
                <div class="item-wrapper">
                    <img class="d-block w-100" src="assets/images/mbr-1-1920x1280.jpg">
                    <div class="mbr-overlay" style="opacity: 0.6; background-color: rgb(35, 35, 35);">
                    </div>
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class="mbr-section-subtitle mbr-fonts-style display-5"></h5>
            ...
            <div class="carousel-item slider-image item">
                <div class="item-wrapper">
                    <img class="d-block w-100" src="assets/images/mbr-2-1920x1280.jpg">
                    <div class="mbr-overlay" style="opacity: 0.6; background-color: rgb(35, 35, 35);">
                    </div>
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class="mbr-section-subtitle mbr-fonts-style display-5"></h5>
        ...
        <a class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#scGtwVK16B">
            <span class="mbri-left mbr-iconfont" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control carousel-control-next" role="button" data-slide="next" href="#scGtwVK16B">
...
<section class="mbr-section contacts1 cid-sbigB0Et6j" id="contacts1-6">
    <!---->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="title col-12">
                <h2 class="align-left mbr-fonts-style display-2">Contacta con nosotros</h2>
            ...
            <div class="col-12 col-md-6">
                <div class="left-block wrapper">
                    <div class="b b-adress">
                        ...
                        <p class="mbr-text align-left mbr-fonts-style display-7">Ciudad de Panamá, Obarrio, Kenex Plaza</p>
                    </div>
                    <div class="b b-phone">
                        <h5 class="align-left mbr-fonts-style m-0 display-5">
                            Phone:
                    ...
                    <div class="b b-mail">
                        ...
                        <p class="mbr-text align-left mbr-fonts-style display-7">info@barbernation.com</p>
                    </div>
                </div>
            </div>
            <!--Right-->
            <div class="col-12 col-md-6">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDk89J4FSunMF33ruMVWJaJht_Ro0kvoXs&amp;q=kenex plaza" allowfullscreen=""></iframe></div>
            </div>
        </div>
    </div>
</section>

<section class="mbr-section form1 cid-sbmub2EnGd" id="form1-j">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">Haz una cita para tu próxima renovación de imagen</h3>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" >
               <!-- Formbuilder Form-->
                <form action="index2.php" method="POST" class="mbr-form form-with-styler" >
                    <div class="row">
                    ...
                    <div class="dragArea row">
                        ...
                        <div class="col-md-4  form-group" data-for="email">
                            <label for="email-form1-j" class="form-control-label mbr-fonts-style display-7">Correo</label>
                            <input type="text" name="email" data-form-field="Email" required="required" class="form-control display-7" id="email-form1-j">
                        </div>
                        <div data-for="phone" class="col-md-4  form-group">
                            <label for="phone-form1-j" class="form-control-label mbr-fonts-style display-7">Teléfono</label>
                            <input type="text" name="phone" data-form-field="Phone" class="form-control display-7" id="phone-form1-j">
                        </div>
                        <div data-for="message" class="col-md-12 form-group">
                            <label for="message-form1-j" class="form-control-label mbr-fonts-style display-7">Mensaje</label>
                            <textarea name="mensaje" data-form-field="Message" class="form-control display-7" id="message-form1-j"></textarea>
                        </div>
